...
class BotHandlers:
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        welcome_text = f"""
🚀 **Ready to transform your file management experience!**

I'm your intelligent file renaming assistant with powerful features:

**🔄 Smart Renaming:**
• Auto mode with custom templates
• Manual mode for precise control
• Support for files up to 5GB

**🎨 Advanced Features:**
• Custom format templates with metadata
• Thumbnail extraction and management
• File metadata editing and enhancement
• Word replacement in filenames
...
Ready to get started? Send me a file or explore the menu below! 👇
        """
